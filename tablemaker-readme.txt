...
―┤バグの報告手順├――――――――――――――――――――――――――――――――――――――――
  ...
  ○報告する際に必要なデータを用意する
    ...
    ・同封の「tablemaker_src.js」を一時的に「tablemaker.js」にリネームする
      ...
      同ファイルのテキストエディターで開き17行目の文頭の「//」を消して保存する
      例…
...
―┤実行方法├―――――――――――――――――――――――――――――――――――――――――――
  ...
  ○同封物／生成物
    ...
    ・scdata/tablemaker.settings
        V2Cのmenu.jsを使用した場合に表の変換設定を記憶するのに必要な設定ファイル
        初期化したい場合はこれを消せばいい
    ・tablemaker.ini
        JaneViewの表の変換設定を記憶するのに必要な設定ファイル
